 ...
 * Description: Footer code for Burrito Masala
 */
?>
...
<!--       Icon links for texting and calling in your order. phone section only visible under 769px, phone_desktop is not visible.  -->
...
<!--    Phone desktop is only visible above 769px  phone is not visible-->
